...
# Reuse all the shims + helpers from the single-layer driver.
from miles_plugins.models.glm5.ops._npu._e2e_megatron_step import (  # noqa: F401  (importing for side-effects: cuda->npu patches, apex stub, etc.)
    _init_distributed,
    _build_config,
